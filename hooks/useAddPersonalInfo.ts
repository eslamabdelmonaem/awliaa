...
export default function useAddPersonalInfo(onSuccessCallback?: () => void, token: string | null = null) {
  ...
  const mutation = useMutation({
    ...
    onError: (error: any) => {
      toast.error('error in adding personal info');
